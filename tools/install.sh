...
_rtkbase_repo(){
    ...
    if [[ -n "${1}" ]]; then
      sudo -u "${RTKBASE_USER}" git clone --branch "${1}" --single-branch https://github.com/buched/rtkbase.git
    else
      sudo -u "${RTKBASE_USER}" git clone https://github.com/buched/rtkbase.git
    fi
